...
export default function PlopFile(plop) {
  ...
  plop.setGenerator('component', {
    ...
    actions: [{
      ...
      skip: function () {
        var _skip2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(name) {
          var filePath, status;
            ...
            while (1) {
              switch (_context2.prev = _context2.next) {
                ...
                case 4:
                  ...
                  return _context2.abrupt("return", 'File already exists');
                ...
                case 9:
                  ...
                  console.log(_context2.t0.desc, 'Creating file...');
        ...
        function skip(_x2) {
          return _skip2.apply(this, arguments);
        }
